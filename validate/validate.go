...
func validatePck(quote any, opts *PCKOptions) error {
	// Extract the PCK. Both QuoteV4 and QuoteV5 expose the signed data containing
	// the PCK certificate chain via the same auth data structure.
